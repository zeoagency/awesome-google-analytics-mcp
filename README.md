...
2. [Ingest data locally and query with SQL (2)](#2-ingest-data-locally-and-query-with-sql)
...
3. [Bridge multi-platform marketing and search data (7)](#3-bridge-multi-platform-marketing-and-search-data)
   - [Unified Search Console and GA4 platforms (2)](#unified-search-console-and-ga4-platforms)
   - [Google Tag Manager audit and event bridges (2)](#google-tag-manager-audit-and-event-bridges)
   - [Multi-ad network and marketing suites (3)](#multi-ad-network-and-marketing-suites)
...
7. [Starter templates and setup scaffolds (1)](#7-starter-templates-and-setup-scaffolds)
   - [Starter templates and boilerplate scaffolds (1)](#starter-templates-and-boilerplate-scaffolds)
...
*A compact comparative matrix of all 47 Model Context Protocol servers and analytical bridges for Google Analytics 4, optimized for quick scanning on standard screens. Click any project name to jump directly to its detailed catalog entry below.*

| Server / Tool | ⭐ Stars | Runtime | Auth Paradigm | Storage | Capabilities & APIs | Primary Specialization | Tier |
| --- | :---: | :---: | :---: | :---: | --- | --- | :---: |
| [**googleanalytics/google-analytics-mcp**](#googleanalytics--google-analytics-mcp) | 3,260 | Python | Dual (SA + PKCE) | Stateless | Reports · Realtime · Funnels · Admin | Official Reference Implementation | Tier 1 (Core) |
| [**surendranb/google-analytics-mcp**](#surendranb--google-analytics-mcp) | 242 | Python | Service Account | Stateless | Reports · Admin | Runtime Schema Introspection & Caching | Tier 1 (Core) |
| [**eiiot/ga4-mcp**](#eiiot--ga4-mcp) | 0 | Python | Dual (SA + PKCE) | Stateless | Reports · Realtime · Funnels · Admin | Consolidated Reporting & Funnels | Tier 1 (Core) |
| [**CUTolu2021/ga4-mcp-server**](#cutolu2021--ga4-mcp-server) | 0 | JavaScript | Service Account | Stateless | Reports · Realtime · Admin | Session-Extracted Telemetry Proxy | Tier 2 (Pioneers) |
| [**mharnett/mcp-ga4**](#mharnett--mcp-ga4) | 0 | TypeScript | Dual (SA + PKCE) | Stateless | Reports · Realtime · Admin | Client Context & Custom Dimensions | Tier 2 (Pioneers) |
| [**fujii-yuji/GA4-MCP-Remote**](#fujii-yuji--ga4-mcp-remote) | 0 | Python | Dual (SA + PKCE) | Stateless | Reports · Realtime · Admin | Remote SSE Multi-Property Stream | Tier 2 (Pioneers) |
| [**Newsstate/ga4-mcp**](#newsstate--ga4-mcp) | 0 | TypeScript | OAuth 2.0 PKCE | Stateless | Reports · Realtime · Admin | Dynamic Schema & Metric Introspection | Tier 4 (Lightweight) |
| [**gviollaz/iita-ga4-mcp**](#gviollaz--iita-ga4-mcp) | 0 | Python | OAuth 2.0 PKCE | Stateless | Reports · Realtime | FastAPI Realtime Telemetry Bridge | Tier 4 (Lightweight) |
| [**paulsign-lab/ga4-mcp**](#paulsign-lab--ga4-mcp) | 0 | Python | Dual (SA + PKCE) | Stateless | Reports · Realtime · Admin | Batch Report Execution & Streaming | Tier 3 (Baseline) |
| [**Leanpicazoo/ga4-mcp**](#leanpicazoo--ga4-mcp) | 0 | Python | Dual (SA + PKCE) | Stateless | Reports · Realtime · Funnels · Admin | Minimalist Data API Bridge | Tier 2 (Pioneers) |
| [**mamaladze22/ga4-mcp**](#mamaladze22--ga4-mcp) | 0 | TypeScript | Dual (SA + PKCE) | Stateless | Reports · Realtime · Funnels · Admin | Structured JSON Reporting Bridge | Tier 2 (Pioneers) |
| [**scalably-io/ga4-mcp**](#scalably-io--ga4-mcp) | 0 | Python | Dual (SA + PKCE) | Stateless | Reports · Realtime · Funnels · Admin | Multi-Tool Dimension Extraction | Tier 2 (Pioneers) |
| [**luminarylane/ga4-mcp**](#luminarylane--ga4-mcp) | 0 | Python | Dual (SA + PKCE) | Stateless | Reports · Realtime · Admin | Opinionated Traffic Source Wrappers | Tier 4 (Lightweight) |
| [**thesyedyahya/ga4-mcp**](#thesyedyahya--ga4-mcp) | 2 | Python | Service Account | Stateless | Reports · Realtime · Admin | Annotation History & Custom Metrics | Tier 4 (Lightweight) |
| [**yusofansari/google-analytics-mcp**](#yusofansari--google-analytics-mcp) | 0 | Python | OAuth 2.0 PKCE | Stateless | Reports · Realtime | Interactive OAuth Query Bridge | Tier 4 (Lightweight) |
| [**CamilaBarbareschi/cafedelirante-ga4-mcp**](#camilabarbareschi--cafedelirante-ga4-mcp) | 0 | Python | OAuth 2.0 PKCE | Stateless | Reports · Realtime | E-Commerce Conversion Tracking | Tier 4 (Lightweight) |
| [**K41R0N/ga4-mcp**](#k41r0n--ga4-mcp) | 0 | TypeScript | Service Account | Stateless | Reports · Realtime | Lightweight Visitor Monitoring | Tier 3 (Baseline) |
| [**Hasim-cim/ga4-mcp**](#hasim-cim--ga4-mcp) | 0 | Python | Service Account | Stateless | Reports · Realtime | Direct Agent Query Bridge | Tier 4 (Lightweight) |
| [**aline-delmain/delmain-ga4-mcp**](#aline-delmain--delmain-ga4-mcp) | 0 | Python | OAuth 2.0 PKCE | Stateless | Reports · Realtime · Admin | Agency Client Preset Reporting | Tier 4 (Lightweight) |
| [**devli13/mcp-ga4**](#devli13--mcp-ga4) | 0 | JavaScript | Service Account | Stateless | Reports · Realtime · Admin | Fast Dimension Slicing | Tier 4 (Lightweight) |
| [**administrator-prog/ga4-mcp**](#administrator-prog--ga4-mcp) | 0 | TypeScript | Service Account | Stateless | Reports · Realtime | Headless Multi-Agent Pipeline | Tier 3 (Baseline) |
| [**sednalabs/ga4-mcp**](#sednalabs--ga4-mcp) | 0 | Rust | Dual (SA + PKCE) | DuckDB OLAP | Reports · Realtime · Funnels · Admin · Local SQL | In-Memory Columnar DuckDB OLAP | Tier 1 (Core) |
| [**fenjo26/OpenGSC**](#fenjo26--opengsc) | 25 | TypeScript | OAuth 2.0 PKCE | SQLite DB | Reports · Admin · Local SQL | SQLite Caching & SQL Query Engine | Tier 1 (Core) |
| [**rablab-mtl/mcp-ga4-gsc**](#rablab-mtl--mcp-ga4-gsc) | 0 | TypeScript | Dual (SA + PKCE) | Stateless | Reports · Realtime · Admin | Unified Search Console & GA4 Platform | Tier 3 (Baseline) |
| [**delaren47/gsc-ga4-mcp**](#delaren47--gsc-ga4-mcp) | 0 | TypeScript | Dual (SA + PKCE) | Stateless | Reports · Realtime · Admin | Organic Landing Page Attribution | Tier 4 (Lightweight) |
| [**CreativeMetrics/gtm-ga4-mcp**](#creativemetrics--gtm-ga4-mcp) | 0 | JavaScript | OAuth 2.0 PKCE | Stateless | Reports · Admin | GTM Container Tag & Schema Auditing | Tier 3 (Baseline) |
| [**kb223/gtm-ga4-mcp**](#kb223--gtm-ga4-mcp) | 1 | Python | OAuth 2.0 PKCE | Stateless | Reports · Realtime · Admin | Tag Trigger & Measurement Correlation | Tier 4 (Lightweight) |
| [**irinabuht12-oss/google-meta-ads-ga4-mcp**](#irinabuht12-oss--google-meta-ads-ga4-mcp) | 2,033 | TypeScript | OAuth 2.0 PKCE | Stateless | Reports · Realtime · Admin | Google & Meta Ads Attribution Hub | Tier 3 (Baseline) |
| [**freema/mcp-google-marketing**](#freema--mcp-google-marketing) | 3 | TypeScript | OAuth 2.0 PKCE | Stateless | Reports · Realtime · Admin | Google Marketing Platform Lifecycle | Tier 3 (Baseline) |
| [**stufently/google-webtools-mcp**](#stufently--google-webtools-mcp) | 7 | TypeScript | Dual (SA + PKCE) | Stateless | Reports · Realtime · Admin | Multi-Platform Marketing Suite | Tier 2 (Pioneers) |
| [**dhawalshah/google-analytics-mcp**](#dhawalshah--google-analytics-mcp) | 0 | Python | OAuth 2.0 PKCE | Stateless | Reports · Realtime · Funnels · Admin | Enterprise Multi-Tenant OAuth Gateway | Tier 1 (Core) |
| [**ESGEE-0562/google-analytics-mcp**](#esgee-0562--google-analytics-mcp) | 0 | Python | OAuth 2.0 PKCE | Stateless | Reports · Realtime · Admin | Encrypted Token Persistence Engine | Tier 2 (Pioneers) |
| [**codeChap/mcp-server-google-analytics**](#codechap--mcp-server-google-analytics) | 0 | Rust | Dual (SA + PKCE) | Stateless | Reports · Realtime · Admin | Zero-Dependency Loopback PKCE | Tier 2 (Pioneers) |
| [**minholi/google-analytics-mcp**](#minholi--google-analytics-mcp) | 1 | Python | OAuth 2.0 PKCE | Stateless | Reports · Realtime | Agency Property Switching Proxy | Tier 2 (Pioneers) |
| [**gomarble-ai/google-analytics-mcp-server**](#gomarble-ai--google-analytics-mcp-server) | 18 | Python | OAuth 2.0 PKCE | Stateless | Reports · Admin | Marketing Team Multi-Account Proxy | Tier 3 (Baseline) |
| [**ankhangonline/mcp-ga4-team-server**](#ankhangonline--mcp-ga4-team-server) | 0 | JavaScript | Service Account | Stateless | Reports · Realtime | Shared Service Account Guardrails | Tier 3 (Baseline) |
| [**mnsmasum62786/was-ga4-mcp**](#mnsmasum62786--was-ga4-mcp) | 0 | JavaScript | OAuth 2.0 PKCE | Stateless | Reports · Realtime · Admin | Remote OAuth Session Proxy | Tier 4 (Lightweight) |
| [**leonardosepulvedat/mcp-google-analytics**](#leonardosepulvedat--mcp-google-analytics) | 2 | TypeScript | Service Account | Stateless | Reports · Realtime · Funnels · Admin · Events | Measurement Protocol Event Dispatch | Tier 2 (Pioneers) |
| [**Insightful-Pipe/google-analytics-mcp-server**](#insightful-pipe--google-analytics-mcp-server) | 0 | TypeScript | OAuth 2.0 PKCE | Stateless | Reports · Admin · Events | Admin API Custom Dimension Manager | Tier 4 (Lightweight) |
| [**HappyMonkeyAI/ai-google-analytics-mcp**](#happymonkeyai--ai-google-analytics-mcp) | 0 | Python | Service Account | Stateless | Reports · Admin | Property Metadata Synchronization | Tier 3 (Baseline) |
| [**mario-hernandez/google-analytics-mcp-claude-code**](#mario-hernandez--google-analytics-mcp-claude-code) | 1 | Python | Dual (SA + PKCE) | Stateless | Reports · Funnels · Admin · Anomalies | Statistical Anomaly Drop Detection | Tier 2 (Pioneers) |
| [**onionst/ga4-toolkit**](#onionst--ga4-toolkit) | 0 | Python | Service Account | Stateless | Reports · Realtime · Admin · Anomalies | Baseline Trend Anomaly Detection | Tier 3 (Baseline) |
| [**TheTechBasket/GA4-Dashboard-MCP**](#thetechbasket--ga4-dashboard-mcp) | 7 | JavaScript | Dual (SA + PKCE) | Stateless | Reports · Realtime · Funnels · Admin | Three.js 3D Interactive Visualizer | Tier 2 (Pioneers) |
| [**inakigorostiza/ga4-mcp-dashboard**](#inakigorostiza--ga4-mcp-dashboard) | 0 | JavaScript | Dual (SA + PKCE) | Stateless | Reports · Realtime | Real-Time Event Stream Dashboard | Tier 3 (Baseline) |
| [**arcbaslow/google-analytics-agent**](#arcbaslow--google-analytics-agent) | 0 | Python | Dual (SA + PKCE) | Stateless | Reports · Realtime · Funnels · Admin · Anomalies | Autonomous Executive Report Compiler | Tier 1 (Core) |
| [**analyticsdatajg2025-cmd/ga4-mcp-powerbi**](#analyticsdatajg2025-cmd--ga4-mcp-powerbi) | 0 | JavaScript | Service Account | Stateless | Reports · Realtime | PowerBI Tabular Data Feeds | Tier 3 (Baseline) |
| [**burhan29ee/ga4-mcp-server**](#burhan29ee--ga4-mcp-server) | 0 | Python | Dual (SA + PKCE) | Stateless | Reports · Realtime · Admin | Modular Python Starter Template | Tier 2 (Pioneers) |

---

## 1. Query standard reports and slice dimensions

*21 projects across 4 subcategories. Executing standard reports, introspecting dimension schemas, and querying realtime telemetry.*
...
*2 projects across 2 subcategories. Caching GA4 telemetry into local analytical databases and executing SQL queries.*
...
*7 projects across 3 subcategories. Uniting GA4 with Google Search Console, Google Tag Manager, and multi-network ad platforms.*

### Unified Search Console and GA4 platforms

*2 projects. Multi-platform servers correlating organic search impressions and queries with downstream GA4 engagement.*
...
*3 projects. Unified marketing hubs coordinating GA4 analytics alongside Google Ads and Meta Ads management.*
...
*7 projects across 4 subcategories. Hardened enterprise OAuth gateways, encrypted token persistence, and multi-tenant proxies.*
...
*3 projects across 2 subcategories. Dispatching Measurement Protocol events and provisioning GA4 properties via Admin API.*
...
*6 projects across 3 subcategories. Statistical anomaly detection, real-time 3D visualizations, and executive report compilers.*
...
*1 project across 1 subcategory. Production boilerplates and setup recipes for authoring custom GA4 MCP servers.*

### Starter templates and boilerplate scaffolds

*1 project. Production boilerplates and setup recipes for authoring custom GA4 MCP servers.*
...
3. **Job-to-Be-Done Taxonomy Bounding:** Repositories are organized into 7 functional domains and 19 subcategories based on actual developer operational needs rather than arbitrary vendor classifications.
